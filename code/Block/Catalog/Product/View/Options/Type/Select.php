...
class Cn_Custopt_Block_Catalog_Product_View_Options_Type_Select 
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $disabled = false;
                if (0 < $_value->getPrice(($_value->getPriceType() == 'percent'))) {
                ...
                $select->addOption(
                    ...
                    $_value->getTitle() . ' ' . $priceStr . '' . ($disabled ? $this->__(' - Disabled for editing') : ''),
                    $params
                );
            }
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input ' . $readonlyTag . ' type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . $_value->getTitle() . ' ' . $priceStr . ($readonly ? $this->__(' - Disabled for editing') : '') . '</label></span>';
                if ($_option->getIsRequire()) {
